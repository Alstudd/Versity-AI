        ...
        {isMenuOpen && (
          <div className="md:hidden border-t border-border/50 bg-card/50 backdrop-blur-sm">
            <div className="px-2 pt-2 pb-3 space-y-1">
              <a href="/study" className="block px-3 py-2 text-sm font-medium text-foreground/80 hover:text-foreground transition-colors">
                Study
              </a>
              <a href="/course" className="block px-3 py-2 text-sm font-medium text-foreground/80 hover:text-foreground transition-colors">
                Courses
              </a>
